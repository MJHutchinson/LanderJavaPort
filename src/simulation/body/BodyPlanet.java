 ...
 */
public class BodyPlanet extends AbstractBody {

    double radius;


    public BodyPlanet(Vector3 position, Vector3 lastPosition, Vector3 rotation, double mass, boolean isGravityAffected) {
